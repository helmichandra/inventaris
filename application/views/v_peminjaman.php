...
<div class="panel">
	...
	<div class="panel-body">
		<h4>
			<i class="glyphicon glyphicon-save"></i>Download PDF</h4>
	</div>
	<div class="panel-body">
		<table class="table table-striped apik">
          ...
          <td>
            ...
            <?php if ($dt_pmnjmn->jumlah_pinjam != 0 ) : ?>
              <a href="<?= base_url('index.php/Peminjaman/kembali/') . $dt_pmnjmn->id_peminjaman ?>" class="btn btn-warning">Dikembalikan</a>
            <?php endif; ?>
