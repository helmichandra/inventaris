    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <a class="active" href="<?=base_url()?>index.php/pegawai">
                        <i class="fa fa-dashboard"></i>
                        <span>Pegawai</span>
                    </a>
                </li>
                <li>
                    <a class="active" href="<?=base_url()?>index.php/inventaris">
                        <i class="fa fa-dashboard"></i>
                        <span>Inventaris</span>
                    </a>
                </li>
                <li>
                    <a class="active" href="<?=base_url()?>index.php/jenis">
                        <i class="fa fa-dashboard"></i>
                        <span>Jenis</span>
                    </a>
                </li>
                ...
                <li>
                    <a class="active" href="<?=base_url()?>index.php/ruang">
                        <i class="fa fa-dashboard"></i>
                        <span>Ruang</span>
                    </a>
                </li>
                <li>
                    <a class="active" href="<?=base_url()?>index.php/peminjaman">
                        <i class="fa fa-dashboard"></i>
...
<!-- calendar -->
	<script type="text/javascript" <?=base_url()?>assets/="<?=base_url()?>assets/js/monthly.js"></script>
