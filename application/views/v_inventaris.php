			...
			<div class="panel-body">
				...
				<tbody>
                    ...
                    foreach ($data_inventaris as $dt_inv) {
                      ...
                      <a href="'.base_url('index.php/Inventaris/hapus_inventaris/'.$dt_inv->id_inventaris).'" class="btn btn-danger" data-toggle="modal" onclick="return confirm(\'anda yakin?\')">Delete</a></td>
