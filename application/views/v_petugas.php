				...
				<tbody>
                    <?php
                              ...
                              foreach ($data_petugas as $dt_ptgs) {
                                ...
                                <a href="'.base_url('index.php/Petugas/hapus_petugas/'.$dt_ptgs->id_petugas).'" class="btn btn-danger" data-toggle="modal" onclick="return confirm(\'anda yakin?\')">Delete</a></td>
